...
Package path after scaffold: shop/lighthappy/app
...
- `SkeletonApp.kt` — Application class → rename to IKEHPApp
...
- `data/datastore/IKEHPOnboardingPrefs.kt` — onboarding flag
...
- `data/repository/IKEHPOnboardingRepo.kt` — onboarding state
...
- `ui/composable/shared/*` — IKEHPContentWrapper, IKEHPEmptyView
